package com.example.parking.Request;
...
public class RequestHttp {
    private static final String HOST = "https://shareparking.kr/";
...
//    }
    ...
    public Call<JsonObject>  imageUpload(String imagePath){
        ...
        return  retrofitApi.uploadImage(MultipartBody.Part.createFormData("image",image.getName(),uploadImage));
    }
